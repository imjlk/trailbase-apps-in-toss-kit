...
function usage() {
  console.log(`Usage:
  node scripts/check-trailbase-version-policy.mjs [--strict] [--version 0.27.9]
  node scripts/check-trailbase-version-policy.mjs [--strict] [--image trailbaseio/trailbase:0.27.9]
  node scripts/check-trailbase-version-policy.mjs [--strict] [--compose docker-compose.yml]

Environment fallbacks:
  TRAILBASE_SERVER_VERSION=0.27.9
  TRAILBASE_IMAGE=trailbaseio/trailbase:0.27.9
  CI_STRICT=1
`);
}
