...
working on TrailBase migrations, auth principal mapping, React Native client
bootstrap, Record API ACL, WASM guests, Coolify deployment, fresh-start behavior,
or mTLS proxy settings.
...
- For React Native client bootstrap, prefer existing kit client adapter helpers
  over app-local SDK/storage/login/session wrappers.
